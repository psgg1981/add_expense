Feature: simple command line documentation usage
	...
	Scenario: run with help shorthand parameter
		Given we have add_expense installed for testing with help shorthand parameter
	...
	Scenario: run with help parameter full label
		Given we have add_expense installed for testing with the help full spec parameter
